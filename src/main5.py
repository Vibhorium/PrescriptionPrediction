...
import Schedule_predicter_NLP

import sys
sys.path.insert(1, '../fuzzywuzzy')

import fuzzy_matching
import fuzzy_common_words
import detect_lines_with_medicine
...
#     output = [line, curr_best_drug, curr_best_Score]
    ...
    print("Preparing schedule of medicines")
    
    Schedule = Schedule_predicter_NLP.schedulePredicter(output)
    for m in Schedule:
        m.printSchedule()
